@include('partials.__header',  isset($data) ? $data['menu_main_categories'] : [])
            ...
            <div class="col-md-4 col-sm-4 ">
              <div class="x_panel tile fixed_height_320">
                ...
                {{-- <div class="x_content">
                  ...
                  <div class="widget_summary">
                    <div class="w_left w_25">
                      <span>How to have fun (Dummies)</span>
                    </div>
                    <div class="w_center w_55">
                      <div class="progress">
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>Technology </p>
                            </td>
                            <td>30%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>Science </p>
                            </td>
                            <td>10%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>Management </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>Poetry </p>
                            </td>
                            <td>15%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square red"></i>Health/Fitness </p>
                            </td>
                            <td>30%</td>
                          </tr>
                        </table>
